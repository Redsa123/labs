...
package list is
	...
	function Get (l : ListT; index : Integer) return Integer;
	procedure Put (l : in out ListT; index : Integer; e : Integer);
	procedure Insert (l : in out ListT; index : Integer; e : Integer);
	procedure Delete (l : in out ListT; index : Integer);
